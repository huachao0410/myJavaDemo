...
import cn.com.bmsoft.base.dao.face.DaoAccessException;
import cn.com.bmsoft.base.dao.face.IDao;
import cn.com.bmsoft.base.dao.mybatis.interceptor.DaoDeleteInterceptor;
import cn.com.bmsoft.base.dao.mybatis.interceptor.DaoInsertInterceptor;
import cn.com.bmsoft.base.dao.mybatis.interceptor.DaoUpdateInterceptor;
...
public abstract class Dao<T> extends SqlSessionDaoSupport implements IDao<T> {
    ...
    public int generatePosition(Map<String, Object> queryParams) {
    	...
    	try {
    		postion = (Integer)super.getSqlSession().selectOne(this.mapperNamespace + ".generatePosition", queryParams);
		} catch (Exception e) {
		}

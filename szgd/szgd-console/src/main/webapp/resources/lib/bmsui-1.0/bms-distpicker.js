...
var Distpicker = function () {
  ...
  createClass(Distpicker, [{
    ...
    value: function getValue(type) {
      ...
      if(!type) {
      	var result = self.$province.find(':selected').val()+ " " + self.$city.find(':selected').val() + " " + self.$district.find(':selected').val();
      	return result;
      }
      
      switch (type) {
        case PROVINCE:
          return self.$province.find(':selected').val();
        case CITY:
          return self.$city.find(':selected').val();
        case DISTRICT:
          return self.$district.find(':selected').val();
      }

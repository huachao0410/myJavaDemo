...
public class Status {
    ...
    static {
        ...
        status.put(40117, "分组名字不合法");
        status.put(40118, "media_id大小不合法");
        status.put(40119, "button类型错误");
        status.put(40120, "button类型错误");
        status.put(40121, "不合法的media_id类型");
        status.put(40132, "微信号不合法");
        status.put(40137, "不支持的图片格式");

...
public class PayServiceImpl implements IPayService {
     ...
     * @throws UnsupportedEncodingException 
     */
    private String packageSign(Map<String, String> params, String paternerKey) throws Exception {
    ...
    public String paySign(String timestamp, String noncestr,String packages) throws Exception {
        ...
        String paySign = DigestUtils.sha256Hex(string1);
        return paySign;
    }
     ...
     * @throws UnsupportedEncodingException 
     */
    public boolean verifySign(long timestamp,
            String noncestr, String openid, int issubscribe, String appsignature) throws Exception {
        Map<String, String> paras = new HashMap<String, String>();
        paras.put("appid", ConfKit.get("AppId"));
        paras.put("appkey", ConfKit.get("paySignKey"));
     ...
     */
    private String deliverSign(Map<String, String> paras) throws Exception {
        paras.put("appkey", ConfKit.get("paySignKey"));
        String string1 = createSign(paras, false);
        String paySign = DigestUtils.sha256Hex(string1);
        return paySign;
    ...
    public boolean delivernotify(String access_token, String openid, String transid, String out_trade_no) throws Exception {
        Map<String, String> paras = new HashMap<String, String>();
        paras.put("appid", ConfKit.get("AppId"));
        paras.put("openid", openid);
